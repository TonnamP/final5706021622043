    ...
    if (event.message && event.message.text) {
      ...
      request({
        ...
        try {
          ...
          var city = body;
          sendTextMessage(sender, "สภาพอากาศวันนี้" + "อุณหภูมิ " + condition.temp + "<br>อุณหภูมิสูง " + condition.temp_max + "อุณหภูมิต่ำสุด " + condition.temp_min + "จังหวัด " + city.name + "," + country.country);
        } catch(err) {
